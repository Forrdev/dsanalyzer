...
enum class GameVersion(
    ...
    fun frameFromMillis(ms: Long): Long = (ms * frameRate / 1000)

    companion object {
        fun fromShortName(name: String): GameVersion? =
            entries.firstOrNull { it.shortName.equals(name, ignoreCase = true) }
    }
}